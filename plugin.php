<?php
/*
Plugin Name: Import Anything
Plugin URI: http://plugin-boutique.com/import-anything/
Description: Import any XML or CSV file to your WordPress website within minutes. It's easily done with our simple user friendly interface. 
Version: 1.0
Author: Anythingimporter
*/
...
if ( class_exists('PMXI_Plugin') and PMXI_EDITION == "free"){
	...
	function pmxi_notice(){
		...
		?>
		<div class="error"><p>
			<?php printf(__('Please de-activate and remove the free version of Import Anything before activating the paid version.', 'pmwi_plugin'));
			?>
		</p></div>
		<?php				
