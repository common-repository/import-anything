				...
				<div class="input">															
					...
					<span class="switcher-target-import_ajax_processing_<?php echo $entry; ?> pl17">
						<div class="input pl17" style="margin:5px 0px;">							
							...
							<a href="#help" class="help" title="<?php printf(__('import anything must be able to process this many records in less than your server\'s max_execution_time, which is %s seconds. If your import fails before finishing (you will see \'Import XML - Error\' in the progress bar), to troubleshoot you should lower this number. If you are importing images, especially high resolution images, high numbers here are probably a bad idea, since downloading the images can take lots of time. 20 posts with 5 images each = 100 images, at 500Kb per image that\'s 50Mb. Can your server download that in less than your max_execution_time? Maybe, maybe not.', 'pmxi_plugin'), ini_get('max_execution_time')); ?>">?</a>							
						</div>
						<div class="input pl17" style="margin:5px 0px;">
