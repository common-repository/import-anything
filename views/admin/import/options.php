...
<div id="record_matching_pointer" style="display:none;">	
	...
	<p>
		<b><?php _e("Record Matching is how Import Anything matches records in your file with posts that already exist WordPress.","pmxi_plugin");?></b>
	</p>

	<p>
		<?php _e("Record Matching is most commonly used to tell Import Anything how to match up records in your file with posts Import Anything has already created on your site, so that if your file is updated with new data, Import Anything can update your posts accordingly.","pmxi_plugin");?>
	</p>
	...
	<p>
		<?php _e("Automatic Record Matching allows Import Anything to update records that were imported or updated during the last run of this same import.","pmxi_plugin");?>
	</p>
	...
	<p>
		<?php _e("Manual record matching allows Import Anything to update any records, even records that were not imported with Import Anything, or are part of a different import.","pmxi_plugin");?>
	</p>
