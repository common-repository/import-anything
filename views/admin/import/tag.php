<div class="tag">		
	...
	<?php if (!empty($elements->length)):?>
		...
		<p class="xpath_help">
			<?php _e('Operate on elements using your own PHP functions, use FOREACH loops, and more.<br />Read the <a href="#" target="_blank">documentation</a> to learn how.', 'pmxi_plugin') ?>
		</p>	
	<?php else: ?>
